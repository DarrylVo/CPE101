...
void test_is_double()
{
   checkit_int(is_double("3.2\0"),1);
   checkit_int(is_double("asdfsadfasdf\0"),0);
   checkit_int(is_double("asdfsadf3.2\0"),0);
   checkit_int(is_double("0.0\0"),1);
   checkit_int(is_double("$#\0"),0);
...
void test_scan_file()
{
   ...
   int a = scan_file(fp,sphere,spheres);
   checkit_double(a,2);

   FILE *fp2;
   fp2=fopen("test2\0","r");
   struct sphere sphere2;
   struct sphere spheres2[10000];
   int b = scan_file(fp2,sphere2,spheres2);
   checkit_double(b,5);
}
...
void test_check_arg()
{
   ...
   argv[4]="5.2";
   argv[5]="6.2";
   check_arg(arg,argv,6);
   checkit_double(arg[0],4.2);
   checkit_double(arg[1],5.2);
   checkit_double(arg[2],6.2);
   ...
   argv2[4]="0.6\0";
   argv2[5]="0.7\0";
   check_arg(arg2,argv2,6);
   checkit_double(arg2[15],0.5);
   checkit_double(arg2[16],0.6);
   checkit_double(arg2[17],0.7);
}

void test_open_file()
{
   FILE* fp10;
   fp10=open_file("test1"); 
